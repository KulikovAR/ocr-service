...
return [
    ...
    */
    ...
    'channels' => [
        ...
        // Graylog конфигурация согласно ТЗ
        'graylog' => [
            'driver' => 'monolog',
            'level' => env('LOG_LEVEL', 'debug'),
            ...
            'formatter_with' => [
                'system_name' => env('GRAYLOG_SOURCE', 'ocr-service'),
                'extra_prefix' => 'extra_',
                'context_prefix' => 'ctx_',
            ],
            'processors' => [PsrLogMessageProcessor::class],
        ...
        // Stack с Graylog для продакшена
        'stack_production' => [
            'driver' => 'stack',
            'channels' => ['graylog', 'daily'],
            'ignore_exceptions' => false,
        ],

        // Stack с Graylog для разработки
        'stack_development' => [
            'driver' => 'stack',
            'channels' => ['graylog', 'single'],
            'ignore_exceptions' => false,
        ],
    ],
