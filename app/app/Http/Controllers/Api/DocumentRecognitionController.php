...
class DocumentRecognitionController extends Controller
{
     ...
     *             @OA\Property(property="data", type="object", description="Распознанные данные (только для completed)", oneOf={
     *                 @OA\Schema(description="Паспорт", example={
     *                     "issuedBy": "string",
     *                     "issueDate": "string",
     *                     "issueId": "string",
     *                     "series": "string",
     ...
     *                     "MRZ2": "string"
     *                 }),
     *                 @OA\Schema(description="Водительское удостоверение", example={
     *                     "series": "string",
     *                     "number": "string",
     *                     "issuedBy": "string",
     *                     "issueDate": "string",
